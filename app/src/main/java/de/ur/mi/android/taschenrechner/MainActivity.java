...
public class MainActivity extends AppCompatActivity implements Numpad.NumpadListener {
     ...
     * Taschenrechner-App
     *
     * Bei der Umsetzung der App wurde versucht, alle notwendigen Funktionen in eigenen, inhaltlich
     ...
     * Komponenten werden die so gefundenen View-Instanzen direkt übergeben. Dadurch benötigten beide
     * Klassen keinen direkten Zugriff auf das Layout der Activity. Die von oben nach unten weiter
     * gegebenen Informationen werden so auf das notwendigste reduziert. So kann u.a. vermieden werden,
     ...
     * Die Numpad-Klasse kommunziert die jeweils gedrückte Schaltfläche über die Übergabe des
     ...
     * neuen Ergebnis und der Darstellung beider Werte verwendet.
     */
    @Override
     ...
     * Parameter übergeben, der den ausgewählten Operator repräsentiert. Dieser wird zur Aktualisierung
     * des aktuellen Terms bzw. dessen Darstellung an die Display-Klasse übergeben.
     */
    @Override
     ...
     * zwei Operatoren ein, interpretiert die App dies als Wunsch, den zu letzt ausgewählten Operator
     * zu überschreiben. Der neue Operator wird von der Activity an die Display-Klasse weitergeben,
